                ...
                <div class="row">
                        ...
                        <div class="row gap-y">
                            ...
                            <div class="col-md-6">
                                <div class="card border hover-shadow-6 mb-6 d-block">
                                    <a href="{{route('showpost',$post->id)}}"><img class="card-img-top" src="{{asset("storage/".$post->image)}}" alt="Card image cap"></a>
                            ...
                            @empty
                            <h3 class="text-center text-danger">no resualts called  <strong>"{{request()->query('search')}}"</strong> </h3>
                            @endforelse
                    ...
                    <div class="col-md-4 col-xl-3">
                        <div class="sidebar px-4 py-md-0">
                            ...
                            <form class="input-group" action="{{route('wellcome')}}" method="GET">
                                <input type="text" class="form-control" name="search" placeholder="Search" value="{{request()->query('search')}}">
                                <div class="input-group-addon">
                                    <span type="submit" class="input-group-text"><i class="ti-search"></i></span>
                                </div>
                            ...
                            <div class="row link-color-default fs-14 lh-24">
                                ...
                                <div class="col-6"><a href="{{route('show.category.posts',$category->id)}}">{{$category->name}}</a></div>
                                @endforeach
                            </div>
                            ...
                            <div class="gap-multiline-items-1">
                                @foreach ($tags as $tag)
                                <a class="badge badge-secondary" href="{{route('show.tag.posts',$tag->id)}}">{{$tag->name}}</a>
                                @endforeach
